  ...
  while Tmp <> nil do
    ...
    begin
      ...
      begin
        ...
        if (CurrAction^.Info.StartWidth = CurrAction^.Info.EndWidth) and
          (CurrAction^.Info.StartHeight = CurrAction^.Info.EndHeight) then
          TObjectImage.Resize(AnimatedPicture, CurrAction^.Info.StartWidth, CurrAction^.Info.StartHeight, IsPng);
        if (CurrAction^.Info.StartAngle = CurrAction^.Info.StartWidth) and
          (CurrAction^.Info.StartWidth = CurrAction^.Info.EndWidth) and
          (CurrAction^.Info.StartHeight = CurrAction^.Info.EndHeight) then
          TObjectImage.Rotate(AnimatedPicture, StartAngle, IsPng);
      end
